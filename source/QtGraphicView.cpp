...
QtGridGraphicView::QtGridGraphicView(QGraphicsScene* scene,
                                     QMenu* menu,
                                     QWidget* parent)
    ...
    , menu_(menu)
{
  ...
  setBackgroundBrush(QColor(QString::fromStdString(
      FLowStyleCollection::defaultStyle().flowViewStyle().BackgroundColor)));
...
void QtGridGraphicView::setStyleCollection(
    std::shared_ptr<FLowStyleCollection> style)
{
  if (!style)
    return;
  ...
  setBackgroundBrush(QColor(QString::fromStdString(
      styleCollection_->flowViewStyle().BackgroundColor)));
}
...
void QtGridGraphicView::drawBackground(QPainter* painter, const QRectF& r)
{
  ...
  auto const& flowViewStyle =
      ((styleCollection_ ? (*styleCollection_)
                         : FLowStyleCollection::defaultStyle()))
          .flowViewStyle();
